...
| [0014](0014-execution-cursor-bounded-check-chat-paging.md) | 仅沟通 Paging Bounded by an Execution Cursor Read Back from Task Records | `ACCEPTED` | 2026-09-23 | Bounded `CHECK_CHAT` paging by the previous acting run's completion time, derived from SUCCESS task records, with the opening page exempt and card stamps compared at their rendered resolution. |
